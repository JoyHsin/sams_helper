...
type MonitorSet struct {
	...
	AddressIndexes  []int `yaml:"addressIndexes"`
}

type Setting struct {
	AuthToken               string                  `yaml:"authToken"`
	RunMode                 int                     `yaml:"runMode"`
	MonitorSet              MonitorSet              `yaml:"monitorSet"`
